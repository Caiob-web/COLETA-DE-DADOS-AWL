...
module.exports = async function handler(req, res) {
  ...
  try {
    // 1) Autenticação com JWT da Service Account
    ...
    // 5) Responde com sucesso e os links do Drive
